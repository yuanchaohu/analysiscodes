...
class dynamics:
    ...
    def __init__(self, inputfile, Neighborfile, ndim, filetype = 'lammps', moltypes = '', *arg):
        """
    ...
    def slowS4(self, X4time, dt = 0.002, a = 1.0, outputfile = ''):
    ...
    def fastS4(self, a = 1.0, dt = 0.002, X4timeset = 0, outputfile = ''):
        """ Compute four-point dynamic structure factor at peak timescale of dynamic susceptibility
