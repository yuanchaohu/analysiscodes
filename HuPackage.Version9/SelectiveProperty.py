...
def dynamics(inputfile, selection, ndim = 3, filetype = 'lammps', moltypes = '', qmax = 0, a = 0.3, dt = 0.002, ppp = [1,1,1], outputfile = ''):
    """
    ...
    for n in range(d.SnapshotNumber - 1): #time interval
        ...
        for ii in range(len(RII)):
            ...
            RII[ii]  = np.dot(matrixij - np.rint(matrixij) * ppp, d.hmatrix[n]) #remove PBC
...
def logdynamics(inputfile, selection, ndim = 3, filetype = 'lammps', moltypes = '', qmax = 0, a = 0.3, dt = 0.002, ppp = [1,1,1], outputfile = ''):
    """
    calculate the dynamical properties of a specific group of atoms
    identified by 'selection' of bool type
...
def partialSq(inputfile, selection, ndim = 3, filetype = 'lammps', moltypes = '', ppp = [1,1,1], Numofq = 500, outputfile = ''):
    """
