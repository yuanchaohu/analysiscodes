...
Docstr = """
         This module is responsible for calculating cage relative particle level dynamics in 2D and 3D
...
class dynamics3d:
    """ Compute cage relative particle dynamics in three dimension """

    def __init__(self, inputfile, Neighborfile, *arg):
...
class dynamics2d:
    """ Compute Cage Relative particle dynamics in two dimension

        consider Mermin-Wanger effects or long wavelength fluctuations
    """
