...
def total(inputfile, ndim, filetype = 'lammps', moltypes = '', qmax = 0, a = 1.0, dt = 0.002, outputfile = ''):
...
def total_PBC(inputfile, ndim, filetype = 'lammps', moltypes = '', qmax = 0, a = 1.0, dt = 0.002, ppp = [1,1,1], outputfile = ''):
    """ Compute self-intermediate scattering functions ISF, dynamic susceptibility ISFX4 based on ISF
        Overlap function Qt and its corresponding dynamic susceptibility QtX4
        Mean-square displacements msd; non-Gaussion parameter alpha2
...
def total_type(inputfile, ndim, filetype = 'lammps', moltypes = '', typeid = 1, qmax = 0, a = 1.0, dt = 0.002, outputfile = ''):
    """ Compute self-intermediate scattering functions ISF, dynamic susceptibility ISFX4 based on ISF
        Overlap function Qt and its corresponding dynamic susceptibility QtX4
        Mean-square displacements msd; non-Gaussion parameter alpha2
    ...
    """
    print ('-----------------Compute Type Dynamics of log output--------------------')
...
def total_PBC_type(inputfile, ndim, filetype = 'lammps', moltypes = '', typeid = 1, qmax = 0, a = 1.0, dt = 0.002, ppp = [1,1,1], outputfile = ''):
    """ Compute self-intermediate scattering functions ISF, dynamic susceptibility ISFX4 based on ISF
        Overlap function Qt and its corresponding dynamic susceptibility QtX4
        Mean-square displacements msd; non-Gaussion parameter alpha2
